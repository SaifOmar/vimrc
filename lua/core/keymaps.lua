...
vim.api.nvim_set_keymap("n", "<C-_>", "gcc", { noremap = false, silent = true })       -- for <C-/>, use <C-_>
vim.api.nvim_set_keymap("v", "<C-_>", "gc", { noremap = false, silent = true })        -- for <C-/>, use <C-_>
vim.api.nvim_set_keymap("i", "<C-_>", "<ESC>gcci", { noremap = false, silent = true }) -- for <C-/>, use <C-_>
